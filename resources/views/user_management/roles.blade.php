                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_country">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-100px">Role Type</th>
                            <th class="min-w-100px">Company Type</th>
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content shadow-none">
            <div class="modal-header">
                <h1 class="text-muted fw-bold">Add new roles</h1>
    ...
    const KTDatatablesServerSide = function() {
        ...
        const initDatatable = function() {
            dt = $("#kt_table_country").DataTable({
                ...
                ajax: '{{ url('admin/user_management/roles/get') }}',
                columns: [
                    {
                        data: 'chRoleName',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            for (const explodes of explode) {
                                datas += `
                                    <div class="badge badge-light fs-6">${explodes}</div>
                                `
                            }
                            return datas;
                        }
