...
<form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="../../demo20/dist/authentication/layouts/fancy/sign-in.html" action="#">
    ...
    <div class="mb-5 fv-row" data-kt-password-meter="true">
        ...
        <div class="mb-1">
            ...
            <div class="form-floating mb-3">
                <input class="form-control form-control-lg bg-transparent" type="password" placeholder="Password" name="password" autocomplete="off" data-kt-translate="new-password-input-password" id="floatingPassword"/>
    ...
    <div class="form-floating fv-row mb-5">
        <input class="form-control form-control-lg bg-transparent" type="password" placeholder="Confirm Password" name="confirm-password" autocomplete="off" data-kt-translate="new-password-confirm-password" id="floatingConfirmPassword"/>
        <label for="floatingConfirmPassword" class="text-gray-500"><span class="bi bi-lock me-2"></span>Confirm Password</label>
    </div>
    <!--end::Input group=-->
    <!--begin::Actions--> 
