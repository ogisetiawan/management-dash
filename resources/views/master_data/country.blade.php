            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search country" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_country">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            <th class="min-w-100px">Country Code</th>
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content shadow-none">
            <div class="modal-header">
                <h1 class="text-muted fw-bold">Add new country</h1>
    ...
    const KTDatatablesServerSide = function() {
        ...
        const initDatatable = function() {
            dt = $("#kt_table_country").DataTable({
                ...
                ajax: '{{ url('admin/master_data/country/get') }}',
                columns: [
                    {
                        data: 'chCountryCode',
                    ...
                    },
                    {
                        data: 'chCountryName',
                        render: function(data, type, row) {
                            const country = data.replaceAll(' ', '-').toLowerCase();
                            return ` 
                                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#kt_modal_2" class="order-2 order-md-1">
                                    <img class="h-20px w-20px rounded-sm me-2" src=\"{{ asset('assets/media/flags/${country}.svg') }}\">
